// Deprecated: One-off WeChat import test has been removed from active code.
throw new Error("[Deprecated] test_wechat_import.mjs has been removed. Perform imports via the app.");
