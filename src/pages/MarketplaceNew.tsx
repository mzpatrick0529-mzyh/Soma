...
const mockAgents: AIAgent[] = [
  {
    ...
    name: "CodeCraft AI",
    tagline: "你的智能编程伙伴",
    description: "CodeCraft AI 是一款革命性的编程助手，支持 50+ 编程Language，提供实时代码补全、bug 检测、代码优化建议。无论你是初学者还是资深开发者，都能从中获益。",
  ...
  },
  {
    ...
    name: "MusicAI Studio",
    tagline: "AI 音乐创作工作室",
    description: "创作专业级音乐，无需音乐理论基础。支持多种曲风，智能and弦进行，Auto配器编曲。",
  ...
  },
  {
    ...
    name: "ChatGenius",
    tagline: "智能对话助手",
    description: "24/7 在线的智能助手，支持自然Language理解，情感识别，多轮对话。可用于客服、教学、陪伴等场景。",
